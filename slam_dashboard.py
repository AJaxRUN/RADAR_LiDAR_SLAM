...
from slam_with_inf import trajectory
import threading
from slam_with_inf import carla_slam_loop
from slam_with_inf import camera_image
from slam_with_inf import lidar_map_points, radar_map_points, nn_lidar_points
...
def update_graph(n):
    from slam_with_inf import imu_trajectory  # Re-import inside callback
